      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 80px;">
        <form method="POST" enctype="multipart/form-data">
          ...
          <p>
            ...
            <input type="text" name="u_pwd" id="u_pwd" required>
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">&emsp;確認密碼</label>
          ...
          <div style="text-align:center;">
            <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">註冊</button>
          </div>
        </br>
        </form>
        <?php
        ...
        $u_pwd=$_POST['u_pwd'];
        echo "$name";
        $SQL="INSERT INTO user(u_name,u_email,u_phone,u_pwd,u_role) VALUES ('$name','$email','$phone','$u_pwd','user')";
