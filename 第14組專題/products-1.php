      ...
      <div class="container body" style="margin: auto;">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="products.html">周邊商店</a></li>
        ...
        <div style="border-style: groove; margin-bottom: 50px; margin-top: 40px; padding: 70px; ">
          
          <div class="container">
            <div class="row">

              <div class="col-md-5 text-center mb-5 mb-md-0">
                <img src="images/products/frog.jpg" alt="" style="width: 300px; height: 300px;">
              </div>

              <div class="col-md-5 align-self-center text-left">
                <h1 style=" text-align: left; margin-bottom: 100px;"><b>來去旅行蛙</b></h1>
                <h3 style="text-align: right; margin-bottom: 20px;"><b>$150</b></h3>
                <h4 style="width: 100%;">陶瓷做成的裝飾品，手提著行李箱不放的他正準備去哪呢?由您來決定吧!</h4>
                <button class="btn btn-success mt-auto my-cart-btn" data-id="1" data-name="product 1" data-summary="summary 1" data-price="10" data-quantity="1" data-image="https://www.jqueryscript.net/demo/Simple-Shopping-Cart-Plugin-With-jQuery-Bootstrap-mycart/images/img_1.png" style="float: right;">
                  加入購物車
                </button>  
              </div>
              <!--認養按鈕-->
