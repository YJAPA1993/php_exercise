...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 80px;">
        <form style="margin:30px auto 0;">
          <h1>會員資料修改</h1></br>
          <p>
            <label for="required-input" style="font-size:20px;">使用者名稱</label>
            <input type="text" id="required-input" required>
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">&emsp;&emsp;&emsp;性別</label>
            <input type="text" id="required-input" required>
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">&emsp;&emsp;&emsp;生日</label>
            <input type="text" id="required-input" required>
          </p>
          <p>
            <label for="optional-input" style="font-size:20px;">&emsp;電子信箱</label>
            <input type="email" id="valid-email" required>
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">&emsp;手機號碼</label>
            <input type="text" id="required-input" required>
          </p>
          </br>
          <div style="text-align:center;">
            <a class="btn btn-primary" href="member-updateInfo-resetpassword.html" style="width: 120px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;" >重設密碼</a>&nbsp;&nbsp;&nbsp;&nbsp;
            <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">送出</button>
          </div>
          </br>
        </form>
