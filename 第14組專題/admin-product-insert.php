      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 100px;">
        <form method = "post"  action="productInsert.php" enctype="multipart/form-data">
          ...
          <p>
            ...
            <input type="text" name="p_name" id="p_name" required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">價錢</label>
            <input type="number" name="p_price" id="p_price" required>&emsp;
          </p>
          <p>
          ...
          <p>
            ...
            <input type="text" name="p_info" id="p_info" required>&emsp;
          </p>
