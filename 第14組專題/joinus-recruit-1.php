      ...
      <div class="container body" style="margin: auto;">
        ...
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.php">首頁</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">人才招募</li>
          </ol>
        </nav>
        <!-- 麵包削結束-->
            ...
            <div class="content" style=" width: 88%; margin: auto; text-align: center; margin: auto; text-align: start;">
              ...
              <div class="content" style="  margin: auto; text-align: center; padding: 1px 100px; text-align: start;">
                <ul style="margin: 20px;">
                  <li>對象：國內外大專院校與本園野生動物物保育業務相關系所之在學學生</li>
                  <li>實習內容：野生動物保育業務範圍相關工作</li>
                  <li>申請時間：暑期實習於每年 4 月受理學校或個人申請，實習時間為 7 月至 8 月兩個月。</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp111年野生動物保育暑期實習受理報名至4/30止，逾時不候。</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp因特殊狀況需求，得不定期提出專案實習申請。</br>
                  </li>
                  <li>申請方式：
                    <ol type="1">
                      <li>繳交「臺北市立動物園野生動物保育實習生申請表」</li>
                      <li>本園經審核書面資料，通知實習申請結果，未錄取者不另行通知。</li>
                    </ol>
                  </li>
                  <li>檔案下載 ： 下載<a href="/assets/file/rectuit.pdf" download="rectuit.pdf">報名文件&nbsp<i class="fa-solid fa-file-arrow-down"></i></a></li>
                  <li>諮詢窗口：
                    <ol type="1">
                      <li>電子郵件：a123@mail.com</li>
                      <li>電話：0912345566</li>
                    </ol>
                  </li>
