    ...
    <main>
      ...
      <div class="container body" style="margin: auto; margin-top: 60px;">
        <h1>購物車</h1>
            ...
            <!-- <?php
                ...
                if($result=mysqli_query($link,$SQL)){
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        echo "<td><a href='productDelete.php?p_name=".$row["p_name"]."'>刪除</a></td>";
                        echo "</tr>";
                    }  
                }
              ?> -->
          ...
          <h4 style="float:right;">總金額：$1000</h4>

          <form  method = "post" enctype="multipart/form-data">
              <label for="required-input"  style="font-size:20px;">地址</label>
              <input type="text" name = "address" id = "address" required>&emsp;
            <div style="text-align:center;">
              <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">下單</button> &nbsp;&nbsp;
            </div>
