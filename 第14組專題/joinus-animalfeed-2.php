      ...
      <div class="container body" style="margin: auto;">
        ...
        <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.php">首頁</a></li>
            ...
            <li class="breadcrumb-item active" aria-current="page">認養計畫</li>
          </ol>
        </nav>
        <!-- 麵包削結束-->
            ...
            <div class="content" style=" width: 88%; margin: auto; text-align: center; margin: auto; text-align: start;">
              ...
              <div class="content" style="  margin: auto; text-align: center; padding: 1px 100px; text-align: start;">
                <ul style="margin: 20px;">
                  <li>活動主題 ： 2022瑪瑪麻吉麻</li>
                  <li>活動日期 ： 2022/04/22</li>
                  <li>活動內容 ： 俗話說~「一年之計在於春」</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 想度過豐富有趣快樂的一年</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 就從兼具機能與美感的桌曆開始</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 動物認養推出 #2022虎曆勇好用桌曆</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 讓 #臺灣淺山動物 及 #超人氣物種 </br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 與你一起開啟新冒險！</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 一起用行動支持動物保育！</br>
                    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp #動物認養捐款指定用於野生動物保育</br>
                  </li><li>下單連結 ： <a href="https://docs.google.com/forms/d/e/1FAIpQLSeOENkLLYWWvPW_ICKIAPuw5Re0bT-E_RfBY-j2lOHAS4AfNg/closedform">購買連結&nbsp<i class="fa-solid fa-file-arrow-down"></i></a></li>
                  <div style="text-align: right; color: gray;">更新時間 ： 2022/02/13</div>
                </ul>
              </div>
            </div>
          </div>
