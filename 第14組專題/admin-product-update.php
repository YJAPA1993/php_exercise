    ...
    <main>
      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 100px;">
        <form  method = "post"  action="updateconfirm.php" enctype="multipart/form-data">
          ...
          <p>
            <label for="required-input"  style="font-size:20px;">商品名字</label>
            <input type="hidden" name ="p_name" value='<?php echo $p_name;?>'>
            <input type="hidden" name ="update" value='3'>
            <input type="text" name="p_name"id="required-input"value='<?php echo $p_name;?>' required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">價錢</label>
            <input type="number" name="p_price"id="required-input"value='<?php echo $p_price;?>' required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">商品圖片</label>
            <input type="file" id="profile_pic" name="photo" accept=".jpg, .jpeg, .png">
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">資訊</label>
            <input type="text" name="p_info" id="required-input" value='<?php echo $p_info;?>'required>&emsp;
          </p>
          <div style="text-align:center;">
            <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">新增商品</button> &nbsp;&nbsp;
          </div>
          </br>
        </form>
      </div>
