  ...
  <body>
    ...
    <main>
      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 100px;">
        <form method = "post"  action="missingInsert.php" enctype="multipart/form-data">
          <h1>新增遺失物</h1>
        </br>
          <p>
            <label for="required-input"  style="font-size:20px;">遺失物名字</label>
            <input type="text" name="m_name" id="m_name" required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">日期</label>
            <input type="date" name="m_date" id="m_date" required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">遺失物圖片</label>
            <input type="file" id="photo" name="photo" accept="image/*">
          </p>
          <div style="text-align:center;">
            <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">新增遺失物</button> &nbsp;&nbsp;
          </div>
          </br>
        </form>
      </div>
