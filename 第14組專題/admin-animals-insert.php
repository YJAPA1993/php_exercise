  ...
  <body>
    ...
    <main>
      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 100px;">
        <form method = "post"  action="animalsInsert.php" enctype="multipart/form-data">
          <h1>新增動物</h1>
        </br>
          <p>
            <label for="required-input"  style="font-size:20px;">動物名字</label>
            <input type="text" name="a_name" id="a_name" required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">動物年齡</label>
            <input type="text" name="a_age" id="a_age" required>&emsp;
          </p>
          <p>
            <label for="required-input" style="font-size:20px;">動物性別</label>
            <input type="text" name="a_gender" id="a_gender" required>&emsp;
          </p>
          <p>
            <label for="required-input"  style="font-size:20px;">動物類別</label>
            <select name="a_type" size="1"required >
                <option>請選擇動物類別</option>
          ...
          <p>
            ...
            <input type="text" name="a_info" id="a_info" required>&emsp;
          </p>
          <p>
          ...
          <div style="text-align:center;">
            <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">新增動物</button> &nbsp;&nbsp;
          </div>
          </br>
        </form>
      </div>
