    ...
    <main>
      ...
      <div class="background-box" style="margin: auto; text-align: center; margin-bottom: 60px; margin-top: 100px;">
        ...
        <p>
          ...
          <input type="text" name="m_name"id="required-input" value='<?php echo $m_name;?>' required>&emsp;
        </p>
        <p>
          <label for="required-input" style="font-size:20px;">日期</label>
          <input type="text" name="m_date"id="required-input"value='<?php echo $m_date;?>' required>&emsp;
        </p>
        <p>
        ...
        <div style="text-align:center;">
          <button class="btn btn-primary" style="width: 100px; height: 40px; border-radius: 20px; border: none; border-bottom: 4px solid #0f1730;background: #4d74a7; font-size: 16px; font-weight: 400; color: #fff;">更新遺失物</button> &nbsp;&nbsp;
        </div>
        </br>
        </form>
      </div>
